...
const ManageTrustedBy = () => {
    ...
    return (
        <div className="min-h-screen text-white p-4 lg:p-8 font-['Manrope'] animate-in fade-in duration-500">
            ...
            <form onSubmit={handleUpdate} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6 bg-[#111827] p-8 rounded-[2.5rem] border border-white/10 shadow-2xl">
                    <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase text-gray-500 ml-2 tracking-widest">Top Slider Text</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase text-gray-500 ml-2 tracking-widest">Badge Text</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase text-gray-500 ml-2 tracking-widest">Heading</label>
                ...
                <div className="space-y-8">
                    <div className="bg-[#111827] p-8 rounded-[2.5rem] border border-white/10 shadow-2xl">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <label className="cursor-pointer bg-white/5 hover:bg-white/10 border border-dashed border-white/20 p-6 rounded-2xl flex-grow text-center transition-all group">
                                ...
                                <span className="text-xs text-gray-400 font-bold uppercase">Replace Main Image</span>
                    ...
                    <div className="bg-[#111827] p-8 rounded-[2.5rem] border border-white/10 shadow-2xl">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-lg font-bold uppercase tracking-tight">Partner Logos</h3>
                            <label className="cursor-pointer bg-blue-600 hover:bg-blue-500 p-2 px-4 rounded-xl transition-all shadow-lg flex items-center gap-2 text-[10px] font-black uppercase tracking-widest">
                        ...
                        <div className="flex gap-4 overflow-x-auto pb-4 custom-scrollbar flex-nowrap items-center">
                            {data.logos.map((logo, idx) => (
                                <div key={`old-${idx}`} className="relative group shrink-0 w-24 h-24 bg-white rounded-xl p-2 flex items-center justify-center shadow-lg border-2 border-transparent hover:border-blue-500 transition-all">
                                    ...
                                    <button type="button" onClick={() => removeExistingLogo(logo)} className="absolute -top-2 -right-2 p-1.5 bg-red-600 text-white rounded-full opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity z-30 shadow-md">
                                        <Trash2 size={12} />
                                    </button>
                                </div>
                            ))}
