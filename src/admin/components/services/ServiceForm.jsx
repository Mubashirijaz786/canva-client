...
import { 
    ...
    MapPin, BarChart2, TrendingUp, FileText, Zap, Link2
} from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {formData.contentItems.map((item, idx) => (
                                <div key={idx} className="bg-[#1e293b]/50 rounded-[2rem] border border-white/5 p-6 space-y-4">
                                    ...
                                    <IconPicker selectedIcon={item.iconName} onChange={(val) => {
                                        const newItems = [...formData.contentItems];
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-[#0f172a] border border-white/10 rounded-[2.5rem] p-8 shadow-2xl">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="flex items-center gap-2 text-lg font-bold italic text-white"><CheckSquare size={20} className="text-cyan-400" /> Page Checklist</h3>
                        ...
                        <div className="bg-[#0f172a] border border-white/10 rounded-[2.5rem] p-8 shadow-2xl">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="flex items-center gap-2 text-lg font-bold italic text-white"><AlertCircle size={20} className="text-red-400" /> Extra Q/A</h3>
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-[#0f172a] border border-blue-500/20 rounded-[2.5rem] p-8 shadow-2xl">
                        <h3 className="flex items-center gap-2 text-lg font-bold italic text-blue-400 mb-6"><Globe size={20} /> SEO & URL</h3>
                        <div className="space-y-4">
                            {/* ✅ NEW: URL SLUG FIELD */}
                            <div className="space-y-1">
                                <label className="text-[9px] font-black text-rose-400 uppercase ml-2 flex items-center gap-1">
                                    <Link2 size={10} /> URL Slug
                                </label>
                                <div className="flex items-center gap-2 bg-[#1e293b] border border-white/10 rounded-2xl px-4 py-3">
                                    <span className="text-gray-500 text-[10px] font-bold">/services/</span>
                                    <input className="bg-transparent text-white outline-none w-full text-xs font-mono" value={formData.slug || ''} onChange={handleSlugChange} placeholder="service-slug" />
                                </div>
                            </div>
                            <div className="space-y-1">
