...
import { Smartphone, CheckCircle2, Cpu } from 'lucide-react';
...
const MobileApp = () => {
    ...
    const defaults = PAGE_DEFAULTS['mobile-app'];

    useEffect(() => {
        const fetchPageContent = async () => {
            try {
                const res = await axiosPublic.get('/service-pages/mobile-app');
                ...
                <div className="container mx-auto max-w-[1400px] relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <h1 className="text-5xl lg:text-7xl font-bold font-['Manrope'] mb-6 leading-[1.1] text-white">
                            {d('heroTitle')} <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-500">{d('heroSubtitle')}</span>
                        </h1>
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl bg-[#0f172a]">
                            <img src={d('heroImage', mobileHero)} alt="Mobile Hero" className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-1000" />
                            <div className="absolute bottom-8 right-8 bg-black/80 backdrop-blur-md p-4 rounded-2xl border border-white/10 flex items-center gap-4 shadow-xl">
                                <div className="w-12 h-12 rounded-full bg-purple-500 flex items-center justify-center text-black"><Cpu size={24} fill="black" /></div>
                                <div>
            ...
            <section className="py-24 bg-gradient-to-b from-[#020617] to-[#0f172a] relative overflow-hidden">
                <div className="container mx-auto px-6 lg:px-16 max-w-[1200px] relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        {/* LEFT SIDE: Process (Using 'reasons' array for Title/Desc) */}
                        <div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative p-8 rounded-3xl bg-[#020617] border border-purple-500/30 shadow-2xl">
                                ...
                                <div className="mt-10 pt-8 border-t border-white/10">
                                    <a href={calendlyLink} target="_blank" rel="noopener noreferrer">
                                        <PrimaryButton className="w-full justify-center !py-4 text-lg">Launch Your App</PrimaryButton>
                                    </a>
                                </div>
                            </div>
                        </div>
